...
from fair_seldonian.constraints.bounds import (
    eval_add_bound, eval_subtract_bound, eval_multiply_bound,
    eval_div_bound, eval_abs_bound, eval_math_bound,
)
...
def test_divide():
    l, u = eval_div_bound(2, 6, 1, 3)
    assert abs(l - 2/3) < 1e-10 and abs(u - 6) < 1e-10
